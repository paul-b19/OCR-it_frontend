        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="text-left">
              <h4><a href="https://github.com/paul-b19/OCR-it_frontend"
                target="_blank">Frontend</a></h4>
              <ul>
                <li>React</li>
                <li>Bootstrap</li>
              </ul>
              <h4><a href="https://github.com/paul-b19/OCR-it_backend"
              ...
              <h6>
                ...
                Pavel Beletsky</a> and <a href="https://www.linkedin.com/in/crpineda/"
                target="_blank"> Carlos Pineda</a>.
              </h6>
            </div>
          </div>
        </div>
